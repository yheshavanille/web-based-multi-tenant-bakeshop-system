            ...
            <nav
                    ...
                    <ul class="flex flex-col gap-y-1">
                        ...
                        <li>
                            <a class="w-full flex items-center gap-x-2 py-2 px-2.5 text-sm text-sidebar-2-nav-foreground rounded-lg hover:bg-sidebar-2-nav-hover focus:outline-hidden focus:bg-sidebar-2-nav-focus "
                                href="{{ route ('livewire.admin.pages.shops.view-shops') }}">
                                View Shops
                            </a>
                        </li>
                    </ul>
                ...
                <div
                    ...
                    <ul class="flex flex-col gap-y-1">
                        <li>
                            <a class="w-full flex items-center gap-x-2 py-2 px-2.5 text-sm text-sidebar-2-nav-foreground rounded-lg hover:bg-sidebar-2-nav-hover focus:outline-hidden focus:bg-sidebar-2-nav-focus"
                                href="{{ route('livewire.admin.pages.users.create-user') }}">
                                Create User
                            </a>
                        </li>
                        <li>
                            <a class="w-full flex items-center gap-x-2 py-2 px-2.5 text-sm text-sidebar-2-nav-foreground rounded-lg hover:bg-sidebar-2-nav-hover focus:outline-hidden focus:bg-sidebar-2-nav-focus"
                                href="{{ route('livewire.admin.pages.users.view-user') }}">
                                View Users
                            </a>
                        </li>
                    </ul>
                    ...
                    <!-- SIMPLE SEPARATOR -->
                    <div class="my-2 border-t border-sidebar-2-divider"></div>
                    <span class="block ps-2.5 mb-2 font-medium text-xs uppercase text-muted-foreground-1">
                        Roles
                    </span>
                    <ul class="flex flex-col gap-y-1">
                        ...
                        <li>
                            <a class="w-full flex items-center gap-x-2 py-2 px-2.5 text-sm text-sidebar-2-nav-foreground rounded-lg hover:bg-sidebar-2-nav-hover focus:outline-hidden focus:bg-sidebar-2-nav-focus"
                                href="{{ route('livewire.admin.pages.role.view-role') }}">
                                View Roles
                            </a>
                        </li>
                    </ul>
