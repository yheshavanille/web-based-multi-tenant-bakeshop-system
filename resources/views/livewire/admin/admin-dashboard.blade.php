<div>
    ...
    <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
            <div>
                <p class="mt-3 text-lg text-foreground">HELLO ADMIN.</p>
                <h1 class="block text-3xl font-bold text-foreground sm:text-4xl lg:text-6xl lg:leading-tight">Welcome to
                    Web-Based Multi-Tenant Bakeshop<span class="text-primary"></span></h1>
                <p class="mt-3 text-lg text-foreground">Where every bread, cake, and pastry is made fresh with love and
            ...
            <div class="relative ms-4">
                <img class="w-full rounded-md" src="https://images.pexels.com/photos/5112588/pexels-photo-5112588.jpeg"
                    alt="Hero Image">
                <div
