<div>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 py-6">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-2xl font-bold text-gray-800">👥 All Employee Activities</h1>
                <p class="text-sm text-gray-500">Track employee actions across all bakeshops</p>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 mb-4">
            ...
            @if($selectedShop !== 'all' || $selectedEmployee !== 'all' || $selectedAction !== 'all' || !empty($search))
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="text-center py-12 text-gray-500">
                ...
                @if($selectedShop !== 'all' || $selectedEmployee !== 'all' || $selectedAction !== 'all' ||
                !empty($search))
