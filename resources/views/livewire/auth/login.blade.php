<div class="relative overflow-hidden min-h-screen bg-white">
    <div class="max-w-7xl w-full mx-auto py-12 px-4 sm:px-6 md:py-20 lg:py-24 md:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <!-- LEFT: Login Form -->
            <div>
                <h1 class="text-3xl text-gray-900 font-bold md:text-4xl"> Welcome to Web-based Multi-tenant Bakeshop
                    with Service Quality Reviews, Ratings, Sales Analytics, and E-payment Services </h1>
                <p class="mt-2 text-gray-600 text-sm leading-relaxed max-w-md"> A complete platform for bakeshops to
                    manage orders, inventory, customer reviews, and sales analytics in one place. </p>
                <div class="bg-white rounded-2xl border border-gray-200 p-6 md:p-8 shadow-sm mt-6">
                    <form wire:submit.prevent="login">
                        <div class="mb-4"> <label for="email" class="block text-sm font-medium text-gray-700 mb-1">Email
                        ...
                        <div class="mb-4"> <label for="password"
                ...
                <p class="mt-4 text-center text-sm text-gray-500"> Don't have an account? <a
                        href="{{ route('livewire.auth.register') }}"
                        class="text-amber-600 hover:text-amber-700 font-medium hover:underline"> Register here </a> </p>
            </div>
        </div>
    </div>
</div>
