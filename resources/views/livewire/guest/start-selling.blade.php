<div>
    <div class="max-w-3xl mx-auto">
        ...
        <div class="mb-6 p-4 bg-yellow-50 border border-yellow-200 text-yellow-800 rounded-lg">
            <p class="font-medium">🔐 Please Login or Register First</p>
            <p class="text-sm">You need to be logged in to start selling.</p>
            <div class="flex flex-wrap gap-3 mt-3">
                <a href="{{ route('livewire.auth.login') }}?start_selling=true"
                    class="text-sm bg-amber-600 text-white px-4 py-2 rounded-lg hover:bg-amber-700 transition inline-block">
                    Login Now →
                </a>
                <a href="{{ route('livewire.auth.register') }}?start_selling=true"
                    class="text-sm bg-gray-200 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-300 transition inline-block">
                    Create Account →
                </a>
            </div>
        </div>
