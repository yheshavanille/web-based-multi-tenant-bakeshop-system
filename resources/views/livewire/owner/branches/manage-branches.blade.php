            ...
            <div class="flex-1 overflow-y-auto px-6 py-4 space-y-4">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    <div class="bg-gray-50 rounded-lg p-3">
                        ...
                        <p class="text-sm font-medium text-gray-800">{{ $selectedOrder->created_at->format('M d, Y h:i A') }}</p>
                    </div>
                    <div class="bg-gray-50 rounded-lg p-3">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full divide-y divide-gray-200 text-sm">
                            ...
                            <tbody class="divide-y divide-gray-200 bg-white">
                                ...
                                <tr>
                                    <td class="px-4 py-2 font-medium text-gray-800">{{ $item->product->name ?? 'N/A' }}</td>
                                    ...
                                    <td class="px-4 py-2">
                                        @if($item->original_price && $item->original_price > $item->price)
                                        <span class="text-gray-400 line-through">₱{{ number_format($item->original_price, 2) }}</span>
                                        @else
                                        <span class="text-gray-400">—</span>
                                        @endif
                                    </td>
                                    <td class="px-4 py-2 text-gray-600">₱{{ number_format($item->price * $item->quantity, 2) }}</td>
                                    <td class="px-4 py-2">
                            ...
                            <tfoot class="bg-gray-50">
                                ...
                                <tr>
                                    <td colspan="7" class="px-4 pt-3 pb-1">
                                        <div class="text-xs font-semibold text-gray-500 uppercase tracking-wider inline-flex items-center gap-1.5">
                                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path>
                                            </svg>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" class="px-4 py-1 font-medium text-gray-800">₱{{ number_format($b['original_subtotal'], 2) }}</td>
                                </tr>
                                <tr>
                                    <td colspan="5" class="px-4 py-1 text-right text-sm text-gray-600">VAT (12%):</td>
                                    <td colspan="2" class="px-4 py-1 font-medium text-gray-800">₱{{ number_format($b['original_vat'], 2) }}</td>
                                </tr>
                                <tr>
                                    <td colspan="5" class="px-4 py-1 text-right text-sm font-semibold text-gray-800">Original Total:</td>
                                    <td colspan="2" class="px-4 py-1 font-bold text-gray-800">₱{{ number_format($b['original_total'], 2) }}</td>
                                </tr>

                                @if($b['amount_charged'] > 0)
                                <tr>
                                    <td colspan="7" class="px-4 pt-3 pb-1 border-t border-gray-200">
                                        <div class="text-xs font-semibold text-green-600 uppercase tracking-wider inline-flex items-center gap-1.5">
                                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <tr>
                                    <td colspan="5" class="px-4 py-0.5 text-right text-xs text-gray-500">• {{ $item['name'] }} ({{ $item['quantity'] }}x)</td>
                                    <td colspan="2" class="px-4 py-0.5 text-xs text-gray-600">₱{{ number_format($item['subtotal'], 2) }}</td>
                                </tr>
                                @endforeach
                                <tr>
                                    <td colspan="5" class="px-4 py-1 text-right text-sm text-gray-600">Completed Items:</td>
                                    <td colspan="2" class="px-4 py-1 font-medium text-gray-800">₱{{ number_format($b['charged_subtotal'], 2) }}</td>
                                </tr>
                                <tr>
                                    <td colspan="5" class="px-4 py-1 text-right text-sm text-gray-600">VAT (12%):</td>
                                    <td colspan="2" class="px-4 py-1 font-medium text-gray-800">₱{{ number_format($b['charged_vat'], 2) }}</td>
                                </tr>
                                <tr>
                                    <td colspan="5" class="px-4 py-1 text-right text-sm font-semibold text-green-700">Amount Charged:</td>
                                    <td colspan="2" class="px-4 py-1 font-bold text-green-600">₱{{ number_format($b['amount_charged'], 2) }}</td>
                                </tr>
                                @endif
                                ...
                                <tr>
                                    <td colspan="7" class="px-4 pt-3 pb-1 border-t border-gray-200">
                                        <div class="text-xs font-semibold text-red-600 uppercase tracking-wider inline-flex items-center gap-1.5">
                                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                @endforeach
                                <tr>
                                    <td colspan="5" class="px-4 py-1 text-right text-sm text-gray-600">No Show / Cancelled:</td>
                                    <td colspan="2" class="px-4 py-1 font-medium text-gray-800">₱{{ number_format($b['not_charged_subtotal'], 2) }}</td>
                                </tr>
                                <tr>
                                    <td colspan="5" class="px-4 py-1 text-right text-sm text-gray-600">VAT (12%):</td>
                                    <td colspan="2" class="px-4 py-1 font-medium text-gray-800">₱{{ number_format($b['not_charged_vat'], 2) }}</td>
                                </tr>
                                <tr>
                                    <td colspan="5" class="px-4 py-1 text-right text-sm font-semibold text-red-700">Amount Not Charged:</td>
                                    <td colspan="2" class="px-4 py-1 font-bold text-red-600">₱{{ number_format($b['amount_not_charged'], 2) }}</td>
                                </tr>
                                @endif
                                ...
                                <tr>
                                    <td colspan="7" class="px-4 pt-3 pb-1 border-t border-gray-200">
                                        <div class="text-xs font-semibold text-amber-600 uppercase tracking-wider inline-flex items-center gap-1.5">
                                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                @endforeach
                                <tr>
                                    <td colspan="5" class="px-4 py-1 text-right text-sm text-gray-600">Pending + Preparing + Ready:</td>
                                    <td colspan="2" class="px-4 py-1 font-medium text-gray-800">₱{{ number_format($b['outstanding_subtotal'], 2) }}</td>
                                </tr>
                                <tr>
                                    <td colspan="5" class="px-4 py-1 text-right text-sm text-gray-600">VAT (12%):</td>
                                    <td colspan="2" class="px-4 py-1 font-medium text-gray-800">₱{{ number_format($b['outstanding_vat'], 2) }}</td>
                                </tr>
                                <tr>
                                    <td colspan="5" class="px-4 py-1 text-right text-sm font-semibold text-amber-700">Amount Outstanding:</td>
                                    <td colspan="2" class="px-4 py-1 font-bold text-amber-600">₱{{ number_format($b['amount_outstanding'], 2) }}</td>
                                </tr>
                                @endif
                            </tfoot>
                        </table>
                ...
                <div class="border-t border-gray-200 pt-4">
                    ...
                    <div class="bg-gray-50 rounded-lg p-3">
                        ...
                        <p class="text-sm text-gray-700">
                            <span class="font-medium">Pickup Time:</span> {{ \Carbon\Carbon::parse($selectedOrder->pickup_time)->format('M d, Y h:i A') }}
                        </p>
                    </div>
                </div>
                @endif
