                    ...
                    <div class="w-full flex items-center gap-x-1.5">
                        ...
                        <ul class="flex flex-row items-center gap-x-3 ms-auto">
                            <li
                                ...
                                <a class="flex items-center gap-x-1.5 py-1.5 px-2 text-sm text-navbar-2-nav-foreground rounded-lg hover:bg-navbar-2-nav-hover focus:outline-hidden focus:bg-navbar-2-nav-focus"
                                    href="{{ route('livewire.owner.public-pages.owner-about-us') }}">
                                    About Us
                                </a>
                                <a class="flex items-center gap-x-1.5 py-1.5 px-2 text-sm text-navbar-2-nav-foreground rounded-lg hover:bg-navbar-2-nav-hover focus:outline-hidden focus:bg-navbar-2-nav-focus"
                                    href="{{ route('livewire.owner.public-pages.owner-teams') }}">
                                    Teams
                                </a>
                            </li>
                            ...
                            <li
                                ...
                                <div class="h-8">
                                    ...
                                    <div
                                        ...
                                        <!-- Account Dropdown -->
                                        <div class="hs-dropdown-menu hs-dropdown-open:opacity-100 w-60 transition- bg-amber-900 [opacity,margin] duration opacity-0 hidden z-20 bg-dropdown border border-dropdown-line rounded-xl shadow-xl"
                                            ...
                                            <div class="px-4 py-2 border-t border-dropdown-divider">
                                                ...
                                                <div class="flex flex-wrap justify-between items-center gap-2">
                                                    <span
                                                        class="flex-1 cursor-pointer text-sm text-foreground">Theme</span>
                                                    <div
                                                        class="p-0.5 inline-flex cursor-pointer bg-surface rounded-full">
                                                        <button type="button"
                                            ...
                                            <div class="p-1 border-t border-dropdown-divider">
                                                <a class="flex items-center gap-x-3 py-2 px-3 rounded-lg text-sm text-dropdown-item-foreground hover:bg-dropdown-item-hover disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden focus:bg-dropdown-item-focus"
                                                    ...
                                                    <svg class="shrink-0 mt-0.5 size-4"
                                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                        viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                                ...
                                                <form method="POST" action="{{ route('livewire.auth.logout') }}">
                                                    @csrf
                                                    <button type="submit"
                                                        class="flex items-center gap-x-3 py-2 px-3 rounded-lg text-sm text-dropdown-item-foreground hover:bg-dropdown-item-hover w-full text-left">
...
lg:block lg:-translate-x-full lg:end-auto lg:bottom-0" role="dialog" tabindex="-1" aria-label="Sidebar">
                <div class="lg:pt-13 relative flex flex-col h-full max-h-full">
                    <!-- Body -->
                    <nav
                        class="p-3 size-full flex flex-col overflow-y-auto  bg-amber-100 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-none [&::-webkit-scrollbar-track]:bg-scrollbar-track [&::-webkit-scrollbar-thumb]:bg-scrollbar-thumb">
                        ...
                        <button type="button"
                            ...
                            Search
                            <span
                                class="ms-auto flex items-center gap-x-1 py-px px-1.5 border border-line-2 rounded-md">
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div
                                    class="pt-3 mt-3 flex flex-col border-t border-sidebar-2-divider first:border-t-0 first:pt-0 first:mt-0">
                                    <span
                                        class="block ps-2.5 mb-2 font-medium text-xs uppercase text-muted-foreground-1">
                                        Manage Branches
                                    </span>
                    ...
                    <!-- Footer -->
                    <footer class="mt-auto p-3 flex flex-col bg-amber-100">
                        <!-- List -->
                        <ul class="flex flex-col gap-y-1">
                            <li>
                                <a class="w-full flex items-center gap-x-2 py-2 px-2.5 text-sm text-sidebar-2-nav-foreground rounded-lg hover:bg-sidebar-2-nav-hover focus:outline-hidden focus:bg-sidebar-2-nav-focus"
            ...
            <main
                ...
                <div class="max-w-340 mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                        <div>
                            <p class="mt-3 text-lg text-foreground">HELLO OWNER.</p>
                            <h1
                                class="block text-3xl font-bold text-foreground sm:text-4xl lg:text-6xl lg:leading-tight">
                                Welcome to
                                Web-Based Multi-Tenant Bakeshop<span class="text-primary"></span></h1>
                            <p class="mt-3 text-lg text-foreground">Where every bread, cake, and pastry is made fresh
                                with love and
                        ...
                        <div class="relative ms-4">
                            <img class="w-full rounded-md"
                                src="https://images.pexels.com/photos/5112588/pexels-photo-5112588.jpeg"
                                alt="Hero Image">
                            <div
