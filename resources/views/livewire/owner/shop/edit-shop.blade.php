    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div class="relative z-10 w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 bg-red-50">
                ...
                <p class="text-xs text-red-600 mt-0.5">This will hide your shop and its data from the platform.</p>
            </div>
            ...
            <div class="px-6 py-4">
                ...
                <p class="text-xs text-gray-500 mb-2">
                    This will be sent to the Super Admin so they understand why you're leaving.
                </p>
                <textarea wire:model="deleteReason" rows="4" maxlength="500"
                    ...
                    placeholder="e.g. Closing the business, relocating, switching platforms..."></textarea>
                @error('deleteReason')
            ...
            <div class="px-6 py-3 border-t border-gray-200 bg-gray-50 flex justify-end gap-2">
                ...
                <button wire:click="deleteShop" wire:loading.attr="disabled"
